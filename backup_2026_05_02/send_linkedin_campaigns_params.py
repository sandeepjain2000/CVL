...
TEMPLATE_FILE     = os.path.join(_SCRIPT_DIR, "email_template_with_link.htm")
PROGRESS_FILE     = os.path.join(_SCRIPT_DIR, "email_progress_linkedin.json")
EXCLUSION_FILE    = os.path.join(_SCRIPT_DIR, "exclusion_list.csv")
